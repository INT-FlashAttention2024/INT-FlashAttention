...
struct Flash_kernel_traits {
    ...
    >;
    using MMA_Atom_Arch_Int8 = MMA_Atom<SM80_16x8x32_S32S8S8S32_TN>; // MMA config for INT8
#else
    using MMA_Atom_Arch = MMA_Atom<SM75_16x8x8_F32F16F16F32_TN>;
    using MMA_Atom_Arch_Int8 = MMA_Atom<SM75_8x8x16_S32S8S8S32_TN>; // MMA config for INT8
#endif

#if defined(__CUDA_ARCH__) &&  __CUDA_ARCH__ >= 750
    using SmemCopyAtom = Copy_Atom<SM75_U32x4_LDSM_N, elem_type>;
    using SmemCopyAtom_Int8 = Copy_Atom<SM75_U32x4_LDSM_N, int8_t>;
    using SmemCopyAtomTransposed = Copy_Atom<SM75_U16x8_LDSM_T, elem_type>;
    // using SmemCopyAtomTransposed_Int8 = Copy_Atom<SM75_U16x8_LDSM_T, int8_t>;
    using SmemCopyAtomTransposed_Int8 = Copy_Atom<DefaultCopy, int8_t>;
#else
    using SmemCopyAtom = Copy_Atom<DefaultCopy, elem_type>;
    using SmemCopyAtom_Int8 = Copy_Atom<DefaultCopy, int8_t>;
...
template<int kHeadDim_, int kBlockM_, int kBlockN_, int kNWarps_, bool Is_Q_in_regs_=false, bool Share_Q_K_smem_=false, typename elem_type=cutlass::half_t, bool Is_QK_Quant_=false, bool Is_V_Quant_=false,
         typename Base=Flash_kernel_traits<kHeadDim_, kBlockM_, kBlockN_, kNWarps_, elem_type> >
struct Flash_fwd_kernel_traits : public Base {
    using Element = typename Base::Element;
    using Element_Int8 = typename Base::Element_Int8;
    using ElementAccum = typename Base::ElementAccum;
    using index_t = typename Base::index_t;
    static constexpr bool Has_cp_async = Base::Has_cp_async;
    using SmemCopyAtom = typename Base::SmemCopyAtom;
    using SmemCopyAtom_Int8 = typename Base::SmemCopyAtom_Int8;
    using SmemCopyAtomTransposed = typename Base::SmemCopyAtomTransposed;
    using SmemCopyAtomTransposed_Int8 = typename Base::SmemCopyAtomTransposed_Int8;
    ...
    static constexpr int kBlockKSmem = (kHeadDim % 64 == 0 && kBlockN % 64 == 0) ? 64 : 32;
    ...
    using TiledMma_Int8 = TiledMMA<
        typename Base::MMA_Atom_Arch_Int8,
    ...
    using SmemLayoutAtomQ_Int8 = decltype(
    ...
    using SmemLayoutQ_Int8 = decltype(tile_to_shape(
        SmemLayoutAtomQ_Int8{},
        Shape<Int<kBlockM>, Int<kHeadDim>>{}));

    using SmemLayoutKV = decltype(tile_to_shape(
        SmemLayoutAtomQ{},
        Shape<Int<kBlockN>, Int<kHeadDim>>{}));
    using SmemLayoutKV_Int8 = decltype(tile_to_shape(
        SmemLayoutAtomQ_Int8{},
        Shape<Int<kBlockN>, Int<kHeadDim>>{}));

    using SmemLayoutP_Int8 = decltype(tile_to_shape(
        SmemLayoutAtomQ_Int8{},
        Shape<Int<kBlockM>, Int<kBlockN>>{}));


    using SmemLayoutQScale = decltype(Layout<Shape<Int<kBlockM>>, Stride<_1>>{});
    using SmemLayoutKVScale = decltype(Layout<Shape<Int<kBlockN>>, Stride<_1>>{});
    using SmemLayoutVScale = decltype(Layout<Shape<Int<kHeadDim>>, Stride<_1>>{});
    ...
    using SmemLayoutVtransposed_Int8 = decltype(
        composition(SmemLayoutKV_Int8{}, make_layout(Shape<Int<kHeadDim>, Int<kBlockN>>{}, GenRowMajor{})));
    using SmemLayoutVtransposedNoSwizzle_Int8 = decltype(get_nonswizzle_portion(SmemLayoutVtransposed_Int8{}));
    ...
    using SmemCopyAtomP = Copy_Atom<DefaultCopy, Element_Int8>;

    static constexpr int kSmemQSize = Is_QK_Quant_ ? size(SmemLayoutQScale{}) * sizeof(float) + size(SmemLayoutQ{}) * sizeof(Element_Int8) : size(SmemLayoutQ{}) * sizeof(Element);
    static constexpr int kSmemKVSize = (Is_QK_Quant_ ? size(SmemLayoutKVScale{}) * sizeof(float) + size(SmemLayoutKV{}) * sizeof(Element_Int8) : size(SmemLayoutKV{}) * sizeof(Element)) + // Smemsize for K
                                        (Is_V_Quant_ ? size(SmemLayoutVScale{}) * sizeof(float) + size(SmemLayoutKV{}) * sizeof(Element_Int8) : size(SmemLayoutKV{}) * sizeof(Element));  // Smemsize for V
    static constexpr int kSmemPSize = Is_V_Quant_ ? size(SmemLayoutP_Int8{}) * sizeof(Element_Int8) : 0;
    static constexpr int kSmemSize = (Share_Q_K_smem ? std::max(kSmemQSize, kSmemKVSize) : kSmemQSize + kSmemKVSize) + kSmemPSize;

    static constexpr int kGmemElemsPerLoad = sizeof(cute::uint128_t) / sizeof(Element);
    static constexpr int kGmemScaleElemsPerLoad = sizeof(cute::uint128_t) / sizeof(float);
    static constexpr int kThrsScaleUsedM = kBlockM / kGmemScaleElemsPerLoad;
    static constexpr int kThrsScaleUsedN = kBlockN / kGmemScaleElemsPerLoad;
    static constexpr int kThrsScaleUsedH = kHeadDim / kGmemScaleElemsPerLoad;
    ...
    static constexpr int kGmemElemsPerLoad_Int8 = sizeof(cute::uint128_t) / sizeof(Element_Int8);
    static_assert(kHeadDim % kGmemElemsPerLoad_Int8 == 0, "kHeadDim must be a multiple of kGmemElemsPerLoad_Int8");
    static constexpr int kGmemThreadsPerRow_Int8 = kBlockKSmem / kGmemElemsPerLoad_Int8;
    static_assert(kNThreads % kGmemThreadsPerRow_Int8 == 0, "kNThreads must be a multiple of kGmemThreadsPerRow_Int8");
    using GmemLayoutAtom_Int8 = Layout<Shape <Int<kNThreads / kGmemThreadsPerRow_Int8>, Int<kGmemThreadsPerRow_Int8>>,
                                      Stride<Int<kGmemThreadsPerRow_Int8>, _1>>;

    using GmemLayoutAtomScale = Layout<Shape <Int<kNThreads>>,
                                       Stride<_1>>;
    ...
    using GmemTiledCopyQKV = decltype(
        make_tiled_copy(Copy_Atom<Gmem_copy_struct, Element>{},
                        GmemLayoutAtom{}, // Thread Layout
                        Layout<Shape<_1, _8>>{}));  // Val layout, 8 vals per read
    using GmemTiledCopyQKV_Int8 = decltype(
        make_tiled_copy(Copy_Atom<Gmem_copy_struct, Element_Int8>{},
                        GmemLayoutAtom_Int8{}, // Thread Layout
                        Layout<Shape<_1, _16>>{}));  // Val layout, 16 vals per read
    using GmemTiledCopyQKVScale = decltype(
        make_tiled_copy(Copy_Atom<Gmem_copy_struct, float>{},
                        GmemLayoutAtomScale{}, // Thread Layout
                        Layout<Shape<_4>>{}));  // Val layout, 8 val per read
    
    // TODO: add a Quant version for spilt KV
